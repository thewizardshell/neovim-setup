...
local prompts = {
  ...
  cleanCode = "Please refactor the following code to follow the principles of Clean Code by Robert C. Martin. Ensure the code is more readable, maintainable, and follows best practices, such as meaningful variable names, small functions, proper indentation, and clear separation of concerns.",
  designpatterns = "Please analyze the following code and recommend an appropriate design pattern to improve its structure, flexibility, and maintainability. Consider factors such as code complexity, scalability, and ease of testing.",
}
